...
import 'package:locateme/Pages/ProfileView.dart';
import 'package:locateme/Pages/JobsView.dart';
import 'package:locateme/Pages/ServiceProviderPages/ServiceProviderHomeView.dart';
...
class ServiceProviderHolderView extends StatelessWidget {
  @override
  ...
  Widget getPage(int value) {
    if (value == 0) {
      return ServiceProviderHomeView();
    } else if (value == 1) {
      return JobsView();
    } else if (value == 2) {
      return ProfileView();
